...
- **Password:** `bk123`
- **Nama:** Psikolog Budi Santoso, M.Psi
...
1. **Ahmad Fauzi** - Tingkat Depresi Berat
   ...
   - Total Tes: 3 (menunjukkan perbaikan)

2. **Siti Rahmawati** - Tingkat Depresi Sedang ke Ringan
   - Email: `mahasiswa2@student.ac.id`
   - Password: `student123`
   - NPM: 2021110002
   - Total Tes: 2 (improving)

3. **Budi Hartono** - Normal
   - Email: `mahasiswa3@student.ac.id`
   - Password: `student123`
   - NPM: 2020110015
   - Total Tes: 2

4. **Dewi Kusuma** - Ringan
...
**Disclaimer:** Sistem ini dikembangkan untuk keperluan penelitian dan edukasi. Hasil tes bukan diagnosis medis resmi. Untuk kondisi serius, segera konsultasikan dengan psikolog atau psikiater profesional.