...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const mapApiTestResult = (test: any): TestResult & Record<string, any> => ({
    ...
    userName: test.userName || test.username || test.name || test.student_name,
    userEmail: test.userEmail || test.useremail || test.email,
    userNim: test.userNim || test.usernim,
    userFaculty: test.userFaculty || test.userfaculty,
    date: test.date,
