...
export const AdminStatistics: React.FC = () => {
  ...
  useEffect(() => {
    if (!user || user.role !== 'admin') {
      ...
      getAllTestResults().then(res => setDummyTestResults(res));
      getAllStudents().then(res => setAllStudents(res));
    }
  ...
  const facultyLevelData = allStudents
    .reduce((acc, student) => {
      ...
      const studentTests = dummyTestResults.filter(t => t.student_id === student.student_id);
